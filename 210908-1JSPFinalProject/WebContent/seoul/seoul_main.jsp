  ...
  <div id="slider" class="clear"> 
    ...
    <div class="flexslider basicslider">
      <ul class="slides">
        ...
        <li><a href="#"><img style="width:978px; height:400px;" class="radius-10" src="../images/demo/slides/seoul_img2.jpg" alt=""></a></li>
        <li><a href="#"><img style="width:978px; height:400px;" class="radius-10" src="../images/demo/slides/seoul_img3.jpg" alt=""></a></li>
      </ul>
    </div>
    <!-- ################################################################################################ --> 
  </div>
